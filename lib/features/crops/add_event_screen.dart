...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  void dispose() {
    ...
    _dieselCtrl.dispose(); _elecCtrl.dispose();
    _irrigationLCtrl.dispose();
    _yieldCtrl.dispose(); _notesCtrl.dispose();
    super.dispose();
  }
  ...
  double get _previewN2o {
    ...
    return n * CropConstants.ipccN2oEmissionFactor *
        (44 / 28) * CropConstants.n2oGwp;
  }
                  ...
                  children: CropConstants.eventTypes.map((type) {
                    ...
                    return GestureDetector(
                      onTap: () => setState(() {
                        ...
                        _nCtrl.clear(); _pCtrl.clear();
                        _kCtrl.clear(); _dieselCtrl.clear();
                        _elecCtrl.clear(); _yieldCtrl.clear();
